...
void DexScreen_PrintNum3LeadingZeroes(u8 windowId, u8 fontId, u16 num, u8 x, u8 y, u8 colorIdx)
{
	...
	if (num > NATIONAL_DEX_PLACEHOLDERLARVA){
		num -= NATIONAL_DEX_PLACEHOLDERLARVA;
		buff[0] = _HYPHEN;
	}

	
	if (num >= NATIONAL_DEX_PETEYPIRANNHA && num < NATIONAL_DEX_REDPIKMIN_VETERAN){
		buff[0] = _QUESTION_MARK;
		buff[1] = _QUESTION_MARK;
		buff[2] = _QUESTION_MARK;
		num = 0;
	}

	switch (num){
	case NATIONAL_DEX_PLACEHOLDERLARVA:
			num = 0;
		break;
	case NATIONAL_DEX_JUMBOBULBORB_MEGA:
			num = NATIONAL_DEX_JUMBOBULBORB;
		break;
	case NATIONAL_DEX_TITANBLOWHOG_MEGA:
			num = NATIONAL_DEX_TITANBLOWHOG;
		break;
	case NATIONAL_DEX_MASTERHOP_MEGA:
			num = NATIONAL_DEX_MASTERHOP;
		break;
	case NATIONAL_DEX_GLINTBEETLE_MEGA:
			num = NATIONAL_DEX_GLINTBEETLE;
		break;
	case NATIONAL_DEX_DIRIGIBUG_MEGA:
			num = NATIONAL_DEX_DIRIGIBUG;
		break;
	case NATIONAL_DEX_GIANTBREADBUG_MEGA:
			num = NATIONAL_DEX_GIANTBREADBUG;
		break;
	case NATIONAL_DEX_SOVREIGNBULBLAX_MEGA:
			num = NATIONAL_DEX_SOVREIGNBULBLAX;
		break;
	case NATIONAL_DEX_DANDELFLY_MEGA:
			num = NATIONAL_DEX_DANDELFLY;
		break;
	case NATIONAL_DEX_PILEATEDSNAGRET_MEGA:
			num = NATIONAL_DEX_PILEATEDSNAGRET;
		break;
	case NATIONAL_DEX_DESICCATEDSKITTERLEAF_MEGA:
			num = NATIONAL_DEX_DESICCATEDSKITTERLEAF;
		break;
	case NATIONAL_DEX_ADULTBULBMIN_MEGAB:
	case NATIONAL_DEX_ADULTBULBMIN_MEGAS:
			num = NATIONAL_DEX_ADULTBULBMIN;
		break;
	case NATIONAL_DEX_MANATLEGS_MEGA:
			num = NATIONAL_DEX_MANATLEGS;
		break;
	case NATIONAL_DEX_VEHEAMOTHPHOSBAT_MEGA:
			num = NATIONAL_DEX_VEHEAMOTHPHOSBAT;
		break;
	case NATIONAL_DEX_PYROCLASTICSLOOCH_MEGA:
			num = NATIONAL_DEX_PYROCLASTICSLOOCH;
		break;
	case NATIONAL_DEX_GREATERSPOTTEDJELLYFLOAT_MEGA:
			num = NATIONAL_DEX_GREATERSPOTTEDJELLYFLOAT;
		break;
	case NATIONAL_DEX_SNOWFLAKEFLUTTERTAIL_MEGA:
			num = NATIONAL_DEX_SNOWFLAKEFLUTTERTAIL;
		break;
	case NATIONAL_DEX_BOGSWALLOW_MEGA:
			num = NATIONAL_DEX_BOGSWALLOW;
		break;
	case NATIONAL_DEX_PUFFMIN_MEGA:
			num = NATIONAL_DEX_PUFFMIN;
		break;
	case NATIONAL_DEX_SCORCHCAKE_MEGA:
			num = NATIONAL_DEX_SCORCHCAKE;
		break;
	case NATIONAL_DEX_PUFFSTOOL_MEGA:
			num = NATIONAL_DEX_PUFFSTOOL;
		break;
	case NATIONAL_DEX_EMPRESSBULBLAX_MEGA:
			num = NATIONAL_DEX_EMPRESSBULBLAX;
		break;
	case NATIONAL_DEX_MUCKERSKATE_MEGA:
			num = NATIONAL_DEX_MUCKERSKATE;
		break;
	case NATIONAL_DEX_GROOVYLONGLEGS_MEGA:
			num = NATIONAL_DEX_GROOVYLONGLEGS;
		break;
	case NATIONAL_DEX_CRUSTEDRUMPUP_MEGA:
			num = NATIONAL_DEX_CRUSTEDRUMPUP;
		break;
	case NATIONAL_DEX_GATTLINGGROINK_MEGA:
			num = NATIONAL_DEX_GATTLINGGROINK;
		break;
	case NATIONAL_DEX_ARMOREDMAWDAD_MEGA:
			num = NATIONAL_DEX_ARMOREDMAWDAD;
		break;
	case NATIONAL_DEX_OATCHI_MEGA:
	case NATIONAL_DEX_OATCHI_MEGAB:
			num = NATIONAL_DEX_OATCHI;
		break;
	case NATIONAL_DEX_QUAGGLEDMIRECLOPS_MEGA:
			num = NATIONAL_DEX_QUAGGLEDMIRECLOPS;
		break;
	case NATIONAL_DEX_WHITEPIKMIN_MEGA:
			num = NATIONAL_DEX_WHITEPIKMIN;
		break;
	case NATIONAL_DEX_BLUEPIKMIN_MEGA:
			num = NATIONAL_DEX_BLUEPIKMIN;
		break;
	case NATIONAL_DEX_ROCKPIKMIN_MEGA:
			num = NATIONAL_DEX_ROCKPIKMIN;
		break;
	case NATIONAL_DEX_YELLOWPIKMIN_MEGA:
			num = NATIONAL_DEX_YELLOWPIKMIN;
		break;
	case NATIONAL_DEX_WINGEDPIKMIN_MEGA:
			num = NATIONAL_DEX_WINGEDPIKMIN;
		break;
	case NATIONAL_DEX_REDPIKMIN_MEGA:
	case NATIONAL_DEX_REDPIKMIN_VETERAN:
			num = NATIONAL_DEX_REDPIKMIN;
		break;
	case NATIONAL_DEX_PURPLEPIKMIN_MEGA:
			num = NATIONAL_DEX_PURPLEPIKMIN;
		break;
	case NATIONAL_DEX_ICEPIKMIN_MEGA:
			num = NATIONAL_DEX_ICEPIKMIN;
		break;
	case NATIONAL_DEX_GLOWPIKMIN_MEGA:
			num = NATIONAL_DEX_GLOWPIKMIN;
		break;
	case NATIONAL_DEX_MOSS_MEGA:
	case NATIONAL_DEX_MOSS_MEGAB:
			num = NATIONAL_DEX_MOSS;
		break;
	case NATIONAL_DEX_WATERYBLOWHOG_MEGA:
			num = NATIONAL_DEX_WATERYBLOWHOG;
		break;
	case NATIONAL_DEX_WHISKERPILLAR_MEGA_S:
	case NATIONAL_DEX_WHISKERPILLAR_MEGA_B:
			num = NATIONAL_DEX_WHISKERPILLAR;
		break;
	case NATIONAL_DEX_HONEYWISP_MEGA:
			num = NATIONAL_DEX_HONEYWISP;
		break;
	case NATIONAL_DEX_MYSTERIOUSLIFEFORM:
			num = NATIONAL_DEX_PLASMWRAITH;
		break;
	}
