...
#define MOVE_PELLETPOWER   0x352
#define MOVE_MEDUSALBEAM   0x353
#define MOVE_DUSTSTORM     0x354
#define MOVE_STONEFANG     0x355
#define MOVE_STONEPUNCH    0x356
#define MOVE_BITTERSPRAY   0x357
#define MOVE_SPICYSPRAY    0x358
#define MOVE_STONEARMOR    0x359
#define MOVE_ROCKYROCK     0x35A
#define MOVE_TREASUREBURST 0x35B
#define MOVE_MUSHMASH      0x35C
#define MOVE_SHROOMFUME    0x35D
#define MOVE_SPOREPUFF     0x35E
#define MOVE_PROQUILLIONOSIS 0x35F

//Z-Moves
enum ZMoves
{
    MOVE_BREAKNECK_BLITZ_P = MOVE_PROQUILLIONOSIS + 1,
...
#define NON_Z_MOVE_COUNT   (MOVE_PROQUILLIONOSIS + 1)
