...
#define ABILITY_COMPOSER ABILITY_PRANKSTER //Sound has raised priority. Apparently not the same as Punk ROck. Oops.
...
#define ABILITY_EMPERORSWHISTLE ABILITY_PUNKROCK